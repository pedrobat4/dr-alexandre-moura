    ...
    <section id="inicio" className="relative">
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 pt-24 pb-16 lg:min-h-[100dvh] lg:grid-cols-12 lg:gap-6 lg:px-8 lg:pb-24">
        <div className="lg:col-span-7">
          <p className="reveal text-xs font-light tracking-[0.2em] text-mist uppercase">
          ...
          >
            Excelência em <span className="font-light text-tan">cada detalhe.</span>
          </h1>
          <p
            className="reveal mt-7 max-w-md text-base font-light leading-relaxed text-mist"
          ...
          <div className="reveal mt-9 flex flex-wrap items-center gap-6" style={{ transitionDelay: '0.24s' }}>
            <a
              ...
              className="group flex items-center gap-3 bg-tan px-7 py-4 text-sm font-medium text-night transition-all hover:bg-tan-deep active:scale-[0.98]"
            >
              Agendar avaliação
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm font-light text-mist transition-colors hover:text-bone"
            >
        ...
        <div className="reveal relative lg:col-span-5" style={{ transitionDelay: '0.12s' }}>
          ...
          />
          <div
            className="absolute -bottom-4 left-4 -z-10 hidden h-full w-full border border-tan/30 lg:block"
            aria-hidden="true"
          />
        </div>
      </div>
